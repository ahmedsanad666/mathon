<template>
  <!-- Footer -->
  <footer
    class="text-center text-lg-start bg-body-tertiary text-muted footerSEction"
  >
    ...
    <section class="row">
      ...
      <div class="col-md-6 col-12 d-flex justify-content-end px-4">
        <div class="footerContacts d-flex justify-content-between w-75 px-4">
          <a
              target="_blank"
              class="wtsicon"
    ...
    <div class="text-center p-4">
      © 2025 Copyright:
      <a class="text-reset fw-bold" href="#">mathon.com</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
